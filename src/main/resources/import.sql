...
INSERT INTO types (id, name) VALUES (1, 'cat') ON CONFLICT DO NOTHING;
INSERT INTO types (id, name) VALUES (2, 'dog') ON CONFLICT DO NOTHING;
INSERT INTO types (id, name) VALUES (3, 'lizard') ON CONFLICT DO NOTHING;
INSERT INTO types (id, name) VALUES (4, 'snake') ON CONFLICT DO NOTHING;
INSERT INTO types (id, name) VALUES (5, 'bird') ON CONFLICT DO NOTHING;
INSERT INTO types (id, name) VALUES (6, 'hamster') ON CONFLICT DO NOTHING;
...
INSERT INTO pets (id, name, birth_date, owner_id, type_id) VALUES (1, 'Leo', '2000-09-07', 1, 1) ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, owner_id, type_id) VALUES (2, 'Basil', '2002-08-06', 6, 2) ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, owner_id, type_id) VALUES (3, 'Rosy', '2001-04-17', 2, 3) ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, owner_id, type_id) VALUES (4, 'Jewel', '2000-03-07', 2, 3) ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, owner_id, type_id) VALUES (5, 'Iggy', '2000-11-30', 3, 4) ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, owner_id, type_id) VALUES (6, 'George', '2000-01-20', 4, 5) ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, owner_id, type_id) VALUES (7, 'Samantha', '1995-09-04', 1, 6) ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, owner_id, type_id) VALUES (8, 'Max', '1995-09-04', 1, 6) ON CONFLICT DO NOTHING;

-- These entries violate some constraints for some reason
-- INSERT INTO pets (id, name, birth_date, owner_id, type_id) VALUES (9, 'Lucky', '1999-08-06', 5, 7) ON CONFLICT DO NOTHING;
-- INSERT INTO pets (id, name, birth_date, owner_id, type_id) VALUES (10, 'Mulligan', '1997-02-24', 2, 8) ON CONFLICT DO NOTHING;
-- INSERT INTO pets (id, name, birth_date, owner_id, type_id) VALUES (11, 'Freddy', '2000-03-09', 5, 9) ON CONFLICT DO NOTHING;
-- INSERT INTO pets (id, name, birth_date, owner_id, type_id) VALUES (12, 'Lucky', '2000-06-24', 2, 10) ON CONFLICT DO NOTHING;
-- INSERT INTO pets (id, name, birth_date, owner_id, type_id) VALUES (13, 'Sly', '2002-06-08', 1, 10) ON CONFLICT DO NOTHING;

-- For some reason the order of the columns are not the same in Quarkus as with Spring and you need to specify the column names (at least for PostgreSQL)
